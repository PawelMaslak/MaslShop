...
namespace Maslshop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return User.IsInRole("Administrator") ? RedirectToAction("Index", "Admin") : RedirectToAction("Index", "Home");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(UserDTO viewModel)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            return _unitOfWork.Admin.GetUserById(userId);
        }
